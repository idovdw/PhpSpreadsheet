...
return [
    ...
    [
        ' $' . str_repeat(' ', 23) . '1,000.00 ',
        '1000',
        NumberFormat::FORMAT_ACCOUNTING_USD,
    ],
    [
        ' $' . str_repeat(' ', 23) . '1,111.11 ',
        '1111.111',
        NumberFormat::FORMAT_ACCOUNTING_USD,
    ],
    [
    ...
    [
        ' $' . str_repeat(' ', 22) . '(1,111.00)',
        '-1111',
        NumberFormat::FORMAT_ACCOUNTING_USD,
    ],
    [
        ' $' . str_repeat(' ', 22) . '(1,111.11)',
        '-1111.111',
        NumberFormat::FORMAT_ACCOUNTING_USD,
    ],
    [
    ...
    [
        ' €' . str_repeat(' ', 21) . '1,000.00 ',
        '1000',
        NumberFormat::FORMAT_ACCOUNTING_EUR,
    ],
    [
        ' €' . str_repeat(' ', 21) . '1,111.11 ',
        '1111.111',
        NumberFormat::FORMAT_ACCOUNTING_EUR,
    ],
    [
    ...
    [
        ' €' . str_repeat(' ', 20) . '(1,111.00)',
        '-1111',
        NumberFormat::FORMAT_ACCOUNTING_EUR,
    ],
    [
        ' €' . str_repeat(' ', 20) . '(1,111.11)',
        '-1111.111',
        NumberFormat::FORMAT_ACCOUNTING_EUR,
    ],
    [
    ...
    'scientific very large complex mask' => ['1000000000000000 000.0', 1e18, '0 000.0'],
    'scientific even larger complex mask' => ['43' . str_repeat('0', 85) . '0 000.0', 4.3e90, '0 000.0'],
