...
/**
 * Formula locale class for ខ្មែរ / Khmer (Cambodia).
 *
 * Do not alter this file; it is generated content.
 */
class LocaleKMxKH extends FormulaLocale
{
    /**
    ...
    protected $aErrorCodesCurrent = [
        ...
        'SPILL' => "#\u{17A0}\u{17C0}\u{179A}!",
        'CONNECT' => '#CONNECT!',
        'BLOCKED' => '#BLOCKED!',
        'UNKNOWN' => '#UNKNOWN!',
        'FIELD' => '#FIELD!',
        'CALC' => '#CALC!',
        'EXTERNAL' => "#\u{1781}\u{17B6}\u{1784}\u{1780}\u{17D2}\u{179A}\u{17C5}!",
    ];
}
