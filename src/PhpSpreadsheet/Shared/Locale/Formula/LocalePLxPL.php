...
/**
 * Formula locale class for Polski / Polish (Poland).
 *
 * Do not alter this file; it is generated content.
 */
class LocalePLxPL extends FormulaLocale
{
    /**
    ...
    protected $aFunctionsLegacy = [
        ...
        'FORECAST.ETS.SEASONALITY' => "REGLINX.ETS.SEZONOWO\u{15A}\u{106}",
        ...
        'NUMBERSTRING' => "LICZBA.CI\u{104}G.ZNAK",
