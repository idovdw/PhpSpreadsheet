...
/**
 * Formula locale class for Latviešu / Latvian (Latvia).
 *
 * Do not alter this file; it is generated content.
 */
class LocaleLVxLV extends FormulaLocale
{
    /**
    ...
    protected $aFunctionsLegacy = [
        // Meklēšanas un atsauču funkcijas (Lookup and reference functions)
        '*RC' => 'RK',
    ];
