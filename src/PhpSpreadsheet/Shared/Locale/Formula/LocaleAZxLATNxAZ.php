...
/**
 * Formula locale class for Azərbaycan / Azerbaijani (Azerbaijan).
 *
 * Do not alter this file; it is generated content.
 */
class LocaleAZxLATNxAZ extends FormulaLocale
{
    /**
    ...
    protected $aErrorCodesCurrent = [
        ...
        'NUM' => '#NUM!',
        'NA' => '#N/A',
        'GETTINGDATA' => "#VER\u{130}L\u{18F}NL\u{18F}R_\u{18F}LD\u{18F}_ED\u{130}L\u{130}R!",
        'SPILL' => '#SIZMA!',
        'CONNECT' => '#CONNECT!',
        'BLOCKED' => '#BLOKLANIB!',
        'UNKNOWN' => '#UNKNOWN!',
