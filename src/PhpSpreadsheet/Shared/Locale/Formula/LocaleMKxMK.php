...
/**
 * Formula locale class for македонски / Macedonian (North Macedonia ).
 *
 * Do not alter this file; it is generated content.
 */
class LocaleMKxMK extends FormulaLocale
{
    /**
    ...
    protected $aInternational = [
        ...
        'xlMinuteCode' => 'm',
        'xlSecondCode' => 's',
        'xlCurrencyCode' => "\u{434}\u{435}\u{43D}.",
    ...
    protected $aErrorCodesCurrent = [
        ...
        'SPILL' => "#\u{41F}\u{420}\u{415}\u{41B}\u{415}\u{412}\u{410}\u{40A}\u{415}!",
        'CONNECT' => '#CONNECT!',
        'BLOCKED' => '#BLOCKED!',
        'UNKNOWN' => '#UNKNOWN!',
        'FIELD' => "#\u{41F}\u{41E}\u{41B}\u{415}!",
        'CALC' => '#CALC!',
        'EXTERNAL' => "#\u{41D}\u{410}\u{414}\u{412}\u{41E}\u{420}\u{415}\u{428}\u{41D}\u{41E}!",
    ];
}
