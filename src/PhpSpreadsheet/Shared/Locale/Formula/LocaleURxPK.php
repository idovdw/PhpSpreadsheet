...
/**
 * Formula locale class for اردو / Urdu (Islamic Republic of Pakistan).
 *
 * Do not alter this file; it is generated content.
 */
class LocaleURxPK extends FormulaLocale
{
    /**
    ...
    protected $aErrorCodesCurrent = [
        ...
        'SPILL' => "#\u{627}\u{633}\u{67E}\u{650}\u{644}!",
        'CONNECT' => '#CONNECT!',
        'BLOCKED' => '#BLOCKED!',
        'UNKNOWN' => '#UNKNOWN!',
        'FIELD' => '#FIELD!',
        'CALC' => '#CALC!',
        'EXTERNAL' => "#\u{628}\u{6CC}\u{631}\u{648}\u{646}\u{6CC}!",
    ];
}
