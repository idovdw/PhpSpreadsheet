...
/**
 * Formula locale class for العربية / Arabic (Saudi Arabia).
 *
 * Do not alter this file; it is generated content.
 */
class LocaleARxSA extends FormulaLocale
{
    /**
    ...
    protected $aInternational = [
        ...
        'xlMinuteCode' => 'm',
        'xlSecondCode' => 's',
        'xlCurrencyCode' => "\u{631}.\u{633}.\u{200F}",
    ...
    protected $aErrorCodesCurrent = [
        ...
        'SPILL' => "#\u{627}\u{644}\u{645}\u{62F} \u{628}\u{627}\u{644}\u{628}\u{64A}\u{627}\u{646}\u{627}\u{62A}!",
        'CONNECT' => '#CONNECT!',
        'BLOCKED' => '#BLOCKED!',
        'UNKNOWN' => '#UNKNOWN!',
        'FIELD' => '#FIELD!',
        'CALC' => '#CALC!',
        'EXTERNAL' => "#\u{62E}\u{627}\u{631}\u{62C}\u{64A}!",
    ];
}
