...
/**
 * Format locale class for العربية / Arabic (U.A.E.).
 *
 * Do not alter this file; it is generated content.
 */
class FormatARxAE extends FormatLocale
{
    /**
     * @var int Language code ID
     */
    protected $lcid = 0x3801;
    ...
    /**
     * @var string The currency code "د.إ.‏"
     */
    protected $strCurrencyCode = "\u{62F}.\u{625}.\u{200F}";
