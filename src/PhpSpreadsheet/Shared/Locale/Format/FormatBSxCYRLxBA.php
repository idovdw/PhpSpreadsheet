...
/**
 * Format locale class for босански / Bosnian (Bosnia and Herzegovina).
 *
 * Do not alter this file; it is generated content.
 */
class FormatBSxCYRLxBA extends FormatLocale
{
    /**
     * @var int Language code ID
     */
    protected $lcid = 0x201A;

    /**
     * @var string The locale tag
     */
    protected $tag = 'bs-cyrl-ba';
