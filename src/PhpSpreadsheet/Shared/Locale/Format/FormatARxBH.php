...
/**
 * Format locale class for العربية / Arabic (Bahrain).
 *
 * Do not alter this file; it is generated content.
 */
class FormatARxBH extends FormatLocale
{
    /**
     * @var int Language code ID
     */
    protected $lcid = 0x3C01;
    ...
    /**
     * @var string The currency code "د.ب.‏"
     */
    protected $strCurrencyCode = "\u{62F}.\u{628}.\u{200F}";
