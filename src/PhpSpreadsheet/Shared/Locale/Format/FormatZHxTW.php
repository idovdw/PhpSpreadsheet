...
/**
 * Format locale class for 中文 / Chinese (Taiwan).
 *
 * Do not alter this file; it is generated content.
 */
class FormatZHxTW extends FormatLocale
{
    /**
     * @var int Language code ID
     */
    protected $lcid = 0x0404;
    ...
    /**
     * @var string The currency code "NT$"
     */
    protected $strCurrencyCode = 'NT$';
