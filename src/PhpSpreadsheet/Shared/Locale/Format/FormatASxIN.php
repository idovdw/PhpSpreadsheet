...
/**
 * Format locale class for অসমীয়া / Assamese (India).
 *
 * Do not alter this file; it is generated content.
 */
class FormatASxIN extends FormatLocale
{
    /**
    ...
    protected $aFormatReplacements = [
        ...
        '[$-F800]dddd, mmmm dd, yyyy' => 'yyyy,mmm dd"{, }"dddd',
        '[$-F400]h:mm:ss AM/PM' => "\"{\u{9F0}\u{9BE}\u{9A4}\u{9BF}\u{9AA}\u{9C1} }\"h:mm:ss",
    ];
}
