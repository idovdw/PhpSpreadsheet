...
/**
 * Format locale class for العربية / Arabic (Morocco).
 *
 * Do not alter this file; it is generated content.
 */
class FormatARxMA extends FormatLocale
{
    /**
     * @var int Language code ID
     */
    protected $lcid = 0x1801;
    ...
    /**
     * @var string The currency code "د.م.‏"
     */
    protected $strCurrencyCode = "\u{62F}.\u{645}.\u{200F}";
