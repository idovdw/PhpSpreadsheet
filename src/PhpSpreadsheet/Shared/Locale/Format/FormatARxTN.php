...
/**
 * Format locale class for العربية / Arabic (Tunisia).
 *
 * Do not alter this file; it is generated content.
 */
class FormatARxTN extends FormatLocale
{
    /**
     * @var int Language code ID
     */
    protected $lcid = 0x1C01;
    ...
    /**
     * @var string The currency code "د.ت.‏"
     */
    protected $strCurrencyCode = "\u{62F}.\u{62A}.\u{200F}";
