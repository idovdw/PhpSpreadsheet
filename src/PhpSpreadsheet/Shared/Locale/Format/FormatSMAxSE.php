...
/**
 * Format locale class for Zuid-Samisch / Southern Sami (Sweden).
 *
 * Do not alter this file; it is generated content.
 */
class FormatSMAxSE extends FormatLocale
{
    /**
     * @var int Language code ID
     */
    protected $lcid = 0x1C3B;

    /**
     * @var string The locale tag
     */
    protected $tag = 'sma-se';

    /**
     * @var string The currency code "SEK"
     */
    protected $strCurrencyCode = 'SEK';
