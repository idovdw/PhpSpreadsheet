...
/**
 * Format locale class for српски / Serbian (Serbia).
 *
 * Do not alter this file; it is generated content.
 */
class FormatSRxCYRLxRS extends FormatLocale
{
    /**
     * @var int Language code ID
     */
    protected $lcid = 0x281A;
    ...
    /**
     * @var string The currency code "дин."
     */
    protected $strCurrencyCode = "\u{434}\u{438}\u{43D}.";
