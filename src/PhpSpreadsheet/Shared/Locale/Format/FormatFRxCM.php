...
/**
 * Format locale class for Français / French (Cameroon).
 *
 * Do not alter this file; it is generated content.
 */
class FormatFRxCM extends FormatLocale
{
    /**
     * @var int Language code ID
     */
    protected $lcid = 0x2C0C;
    ...
    /**
     * @var string The currency code "FCFA"
     */
    protected $strCurrencyCode = 'FCFA';
