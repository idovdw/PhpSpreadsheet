...
/**
 * Format locale class for العربية / Arabic (Iraq).
 *
 * Do not alter this file; it is generated content.
 */
class FormatARxIQ extends FormatLocale
{
    /**
     * @var int Language code ID
     */
    protected $lcid = 0x0801;
    ...
    /**
     * @var string The currency code "د.ع.‏"
     */
    protected $strCurrencyCode = "\u{62F}.\u{639}.\u{200F}";
