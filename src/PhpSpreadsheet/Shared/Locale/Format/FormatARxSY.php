...
/**
 * Format locale class for العربية / Arabic (Syria).
 *
 * Do not alter this file; it is generated content.
 */
class FormatARxSY extends FormatLocale
{
    /**
     * @var int Language code ID
     */
    protected $lcid = 0x2801;
    ...
    /**
     * @var string The currency code "ل.س.‏"
     */
    protected $strCurrencyCode = "\u{644}.\u{633}.\u{200F}";
