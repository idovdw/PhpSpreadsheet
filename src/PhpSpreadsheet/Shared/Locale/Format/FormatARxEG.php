...
/**
 * Format locale class for العربية / Arabic (Egypt).
 *
 * Do not alter this file; it is generated content.
 */
class FormatARxEG extends FormatLocale
{
    /**
     * @var int Language code ID
     */
    protected $lcid = 0x0C01;
    ...
    /**
     * @var string The currency code "ج.م.‏"
     */
    protected $strCurrencyCode = "\u{62C}.\u{645}.\u{200F}";
