...
/**
 * Format locale class for Français / French (Congo, DRC).
 *
 * Do not alter this file; it is generated content.
 */
class FormatFRxCD extends FormatLocale
{
    /**
     * @var int Language code ID
     */
    protected $lcid = 0x240C;
    ...
    /**
     * @var string The currency code "FC"
     */
    protected $strCurrencyCode = 'FC';
