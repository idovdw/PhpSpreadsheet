...
/**
 * Format locale class for Magyar / Hungarian (Hungary).
 *
 * Do not alter this file; it is generated content.
 */
class FormatHUxHU extends FormatLocale
{
    /**
     * @var int Language code ID
     */
    protected $lcid = 0x040E;
    ...
    /**
     * @var string The currency code "Ft"
     */
    protected $strCurrencyCode = 'Ft';
    ...
    protected $aFormatReplacements = [
        ...
        '[$-F800]dddd, mmmm dd, yyyy' => 'yyyy"{. }"ssss d"{., }"dddd',
        '[$-F400]h:mm:ss AM/PM' => 'm:ss:ss',
        '# ?/4' => '#\,?/4',
        '# ??/100' => '#\,??/100',
        '# ?/8' => '#\,?/8',
        '# ???/???' => '#\,???/???',
