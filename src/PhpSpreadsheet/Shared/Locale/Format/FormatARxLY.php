...
/**
 * Format locale class for العربية / Arabic (Libya).
 *
 * Do not alter this file; it is generated content.
 */
class FormatARxLY extends FormatLocale
{
    /**
     * @var int Language code ID
     */
    protected $lcid = 0x1001;
    ...
    /**
     * @var string The currency code "د.ل.‏"
     */
    protected $strCurrencyCode = "\u{62F}.\u{644}.\u{200F}";
