...
/**
 * Format locale class for العربية / Arabic (Oman).
 *
 * Do not alter this file; it is generated content.
 */
class FormatARxOM extends FormatLocale
{
    /**
     * @var int Language code ID
     */
    protected $lcid = 0x2001;
    ...
    /**
     * @var string The currency code "ر.ع.‏"
     */
    protected $strCurrencyCode = "\u{631}.\u{639}.\u{200F}";
