...
/**
 * Format locale class for العربية / Arabic (Lebanon).
 *
 * Do not alter this file; it is generated content.
 */
class FormatARxLB extends FormatLocale
{
    /**
     * @var int Language code ID
     */
    protected $lcid = 0x3001;
    ...
    /**
     * @var string The currency code "ل.ل.‏"
     */
    protected $strCurrencyCode = "\u{644}.\u{644}.\u{200F}";
