...
/**
 * Format locale class for العربية / Arabic (Algeria).
 *
 * Do not alter this file; it is generated content.
 */
class FormatARxDZ extends FormatLocale
{
    /**
     * @var int Language code ID
     */
    protected $lcid = 0x1401;
    ...
    /**
     * @var string The currency code "د.ج.‏"
     */
    protected $strCurrencyCode = "\u{62F}.\u{62C}.\u{200F}";
