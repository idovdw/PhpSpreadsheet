...
/**
 * Format locale class for Français / French (Haiti).
 *
 * Do not alter this file; it is generated content.
 */
class FormatFRxHT extends FormatLocale
{
    /**
     * @var int Language code ID
     */
    protected $lcid = 0x3C0C;
    ...
    /**
     * @var string The currency code "G"
     */
    protected $strCurrencyCode = 'G';
