...
/**
 * Format locale class for 中文 / Chinese (Macao S.A.R.).
 *
 * Do not alter this file; it is generated content.
 */
class FormatZHxMO extends FormatLocale
{
    /**
     * @var int Language code ID
     */
    protected $lcid = 0x1404;
    ...
    /**
     * @var string The currency code "MOP$"
     */
    protected $strCurrencyCode = 'MOP$';
