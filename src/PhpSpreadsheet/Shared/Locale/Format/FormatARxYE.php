...
/**
 * Format locale class for العربية / Arabic (Yemen).
 *
 * Do not alter this file; it is generated content.
 */
class FormatARxYE extends FormatLocale
{
    /**
     * @var int Language code ID
     */
    protected $lcid = 0x2401;
    ...
    /**
     * @var string The currency code "ر.ي.‏"
     */
    protected $strCurrencyCode = "\u{631}.\u{64A}.\u{200F}";
