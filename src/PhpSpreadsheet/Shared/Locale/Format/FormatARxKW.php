...
/**
 * Format locale class for العربية / Arabic (Kuwait).
 *
 * Do not alter this file; it is generated content.
 */
class FormatARxKW extends FormatLocale
{
    /**
     * @var int Language code ID
     */
    protected $lcid = 0x3401;
    ...
    /**
     * @var string The currency code "د.ك.‏"
     */
    protected $strCurrencyCode = "\u{62F}.\u{643}.\u{200F}";
