...
abstract class FormulaLocale
{
     ...
     */
    protected static $aInternationalKeys = [
        1 => 'xlCountryCode',
        2 => 'xlCountrySetting',
    ...
    public function getFunctions()
    {
        if (self::$VERSION_MODE == self::VERSION_CURRENT) {
            return $this->aFunctionsCurrent;
        }

        return $this->aFunctionsLegacy;
    }

    /**
     * Retrieve the error codes list.
     *
     * @return array<string, string> The list of error codes indexed by the
     * international error code
     */
    public function getErrorCodes()
    {
        if (self::$VERSION_MODE == self::VERSION_CURRENT) {
            return $this->aErrorCodesCurrent;
        }

        return $this->aErrorCodesLegacy;
    }
    ...
    public function getInternational($key)
    {
        if (is_int($key)) {
            ...
            $key = self::$aInternationalKeys[$key] ?? $key;
        }
