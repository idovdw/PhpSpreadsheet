...
class Calculation
{
    ...
    /**
     * Set which version to use (current or legacy).
     *
     * @param string $version The version version ('legacy', 'current')
     */
     ...
     *
     * @return string The locale slug, eg: 'en_us'
     */
     ...
     * Set the locale code.
     *
     * @param string $locale The locale to use for formula translation, eg: 'en_us', 'pt-br'
     *
    ...
    public function setLocale(string $locale)
    {
        ...
        // Clear translation lists
        self::$functionReplaceFromExcel = null;
        self::$functionReplaceToLocale = null;
        self::$functionReplaceFromLocale = null;
        self::$functionReplaceToExcel = null;
