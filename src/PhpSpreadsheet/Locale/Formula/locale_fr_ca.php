 ...
 */
class locale_fr_ca extends FormulaLocale
{
    /**
     ...
     */
    protected $aBooleanRepresentation = ["TRUE" => "VRAI", "FALSE" => "FAUX", "NULL" => "NULL"];
    ...
    protected $functions_current = array(
        ...
        "SLOPE" => "PENTE",
        "SMALL" => "PETITE.VALEUR",
        "STDEV.P" => "ÉCARTYPE.PEARSON",
        "STDEV.S" => "ÉCARTYPE.STANDARD",
