...
class FormulaLocaleFactory
{
     ...
     */
    protected static $locale_translations = [
        'ar-ae' => 'ar-sa',
        'ar-bh' => 'ar-sa',
        'ar-dz' => 'ar-sa',
        'ar-eg' => 'ar-sa',
     ...
     *
     * @return false|FormulaLocale The locale object, false if not found
     */
     ...
     *
     * @return null|string|true The locale tag based upon the LCID
